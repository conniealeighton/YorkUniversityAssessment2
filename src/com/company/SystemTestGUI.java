...
public class SystemTestGUI
{
    ...
    public static void main(String[] args) {
        ...
        while (true)
        {
            ...
            } else if (input.equals("Set Details"))
            {
                ...
                {
                    showErrorMessage(outputArea, e.getMessage());
                }
    ...
    private static void showErrorMessage(JTextArea outputArea, String errorMessage)
    {
        outputArea.setText("Data entry error: " + errorMessage);
